...
<body>
	...
	<div class="container">
		<h2>Liste des bulletins de salaire</h2>
		<div class="row">
			<div class="offset-9 col-3">
				<a href="creer"><button class="btn btn-dark">Créer un nouveau bulletin</button></a>
			</div>
		</div>
		...
		<table class="table table-striped">
			...
			<tbody>
				<c:forEach var="bulletin" items="${fullBulletin}">
					<tr>
